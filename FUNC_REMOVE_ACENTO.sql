/*    ==Par‚metros de Script==
    ...
    EdiÁ„o do Mecanismo de Banco de Dados de Origem : EdiÁ„o do Banco de Dados SQL do Microsoft Azure
    Tipo do Mecanismo de Banco de Dados de Origem : Banco de Dados SQL do Microsoft Azure

    EdiÁ„o de Mecanismo de Banco de Dados de Destino : EdiÁ„o do Banco de Dados SQL do Microsoft Azure
    Tipo de Mecanismo de Banco de Dados de Destino : Banco de Dados SQL do Microsoft Azure
*/

/****** Object:  UserDefinedFunction [dbo].[FUNC_REMOVE_ACENTO]    Script Date: 09/12/2019 11:27:22 ******/
SET ANSI_NULLS ON
GO
