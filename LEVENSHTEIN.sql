...
/****** Object:  UserDefinedFunction [dbo].[LEVENSHTEIN]    Script Date: 09/12/2019 11:29:34 ******/
SET ANSI_NULLS ON
GO
...
CREATE function [dbo].[LEVENSHTEIN] ( @SourceString nvarchar(max), @TargetString nvarchar(max) ) 
